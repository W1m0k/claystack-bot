...
// const privateKeys = require("../../credentials/secret.json");
// const donatorPks = require("../../credentials/donator.json");
// const inviterPks = require("../../credentials/inviter.json");
// const inviteePks = require("../../credentials/invitee.json");
...
// const wallets = privateKeys.map((pk) => new ethers.Wallet(pk, goerliProvider));
// const donatorWallets = donatorPks.map(
//   (pk) => new ethers.Wallet(pk, goerliProvider)
// );
// const inviterWallets = inviterPks.map(
//   (pk) => new ethers.Wallet(pk, goerliProvider)
// );
// const inviteeWallets = inviteePks.map(
//   (pk) => new ethers.Wallet(pk, goerliProvider)
// );
